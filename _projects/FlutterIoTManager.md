---
layout: page
title: FlutterIoTManager
description: 📱 Manage your IoT devices easily
full_name: mpek29/FlutterIoTManager
img: assets/img/projects/FlutterIoTManager/main.png
importance: 1
git: https://github.com/mpek29/FlutterIoTManager
github: https://github.com/mpek29/FlutterIoTManager
...
|-----------|-----------|-----------|
| {% include image.html path="assets/img/projects/FlutterIoTManager/device_list.png" width="100%" %} | {% include image.html path="assets/img/projects/FlutterIoTManager/product.png" width="100%" %} | <img src="assets/img/settings"> |
